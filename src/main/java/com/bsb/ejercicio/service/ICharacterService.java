...
public interface ICharacterService {
      List<CharacterResponse> findName(String name) throws ErrorProcessException;
      ...
      CharacterResponse update(Long id, CharacterRequest character) throws ErrorProcessException;
}
